...
func on_timer_timeout():
	...
	sword_instace.global_position += Vector2.RIGHT.rotated(randf_range(0,TAU)) * 4
	
	var enemy_direction = enemies[0].global_position - sword_instace.global_position
	sword_instace.rotation = enemy_direction.angle()
